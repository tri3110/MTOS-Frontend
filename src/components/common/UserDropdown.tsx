  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        !rounded-none border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        <div>
        ...
        <button
          ...
          dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300  border-b border-gray-200"
        >
          <svg
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
