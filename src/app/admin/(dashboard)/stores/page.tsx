...
export default function StorePage() {
    ...
    const [dataEdit, setDataEdit] = useState<StoreType | null>(null);
    const [dataObject, setDataObject] = useState<StoreType[]>([]);
    ...
    const handleEditForm = (data: StoreType) =>{
        setDataEdit(data);
        setTimeout(() => {
            setIsOpen(true);
        }, 200);
    ...
    const columnDefs = useMemo<ColDef<StoreType>[]>(() => [
        { 
            headerName: "No", 
    ...
    return (
        ...
        <StoreDialogAdd 
            ...
            onUpdateSuccess = {(updatedItem: StoreType)=>{
                setDataObject(prev =>
